...
class ImageConverterWindow(BaseWindow):
    """Window for the Image Converter, inheriting from BaseWindow."""

    def __init__(self, parent):
        super().__init__(parent, title="Oneverter - Image Converter", geometry="1024x768")
    ...
    def setup_ui(self):
        """Setup the image converter UI with a responsive layout."""
        ...
        title_label = ctk.CTkLabel(
            header_frame, text="🖼️ Image Converter", font=ctk.CTkFont(size=24, weight="bold")
        )
